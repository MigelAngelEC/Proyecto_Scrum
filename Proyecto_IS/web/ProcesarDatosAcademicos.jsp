...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="jumbotron">
                <%
                    String Instituto, Titulo, espe, nickname;
                    int Nivel = 0;
                    nickname = request.getParameter("nickne");
                    Instituto = request.getParameter("Instituto");
                    Titulo = request.getParameter("Titulo");
                    Nivel = Integer.parseInt(request.getParameter("ComboPer"));
                    espe = request.getParameter("Espe");
                    clsInfoAcademica obj = new clsInfoAcademica();
                    Boolean eject = obj.InsertarInforAc(nickname, Instituto, Titulo, Nivel, espe);
                    if (eject = true) {
                        out.print("<br><h2>Información Academica Registrada </h2>");
                        ...
                        out.print("<br>Fallo al Registrar Información Academica " + eject);
